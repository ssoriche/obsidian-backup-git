# Obsidian Local Git Plugin

Automatic local git versioning for Obsidian without remote sync.

## Features

- **Local Git Versioning**: Automatically commit changes to a local git repository
...
Configure the plugin behavior in Settings → Local Git Backup:
